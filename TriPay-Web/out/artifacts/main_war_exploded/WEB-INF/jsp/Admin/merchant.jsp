...
<div align="right"><h5><b>total transactions amount:Rs ${totaltx}</b></h5></div>
                </div>
...
<%-- 							<form action="<c:url value="/Admin/neftListFiltered"/>" method="post" class="form form-inline"> --%>
...
<!--                             </form>  -->
						...
						<th>Status</th>
                                    ...
                                    <tbody id="userList">
                                    <c:forEach items="${userList}" var="neft"
                                               varStatus="loopCounter">
                                        <tr>
                                            <td>${loopCounter.count}</td>
                                            <td><b>Name:</b><c:out value="${neft.username}" default=""
                                                       escapeXml="true" /><br/>
                                                <b>Email</b><c:out value="${neft.email}" default=""
                                                                   escapeXml="true" /><br/>
                                            </td>
                                            <td><c:out value="${neft.currentBalance}"
                                                       default="" escapeXml="true" /></td>
                                            <td><c:out value="${neft.transactionRefNo}"
                                                       default="" escapeXml="true" /></td>
                                            <td><c:out value="${neft.date}"
                                                       escapeXml="true" default="" /></td>
                                           
                                            <td><c:out value="${neft.serviceType}"
                                                       escapeXml="true" default="" /></td>
