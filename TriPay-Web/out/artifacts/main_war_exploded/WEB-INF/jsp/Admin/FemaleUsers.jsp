...
<sec:csrfMetaTags/>
<title>VPayQwik | Female Users</title>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<table id="datatable"
										...
										<tbody>
											<c:forEach items="${userList}" var="u" varStatus="loopCount">
												<tr>
												<td>${loopCount.count}</td>
													<td><b>User Name : </b><c:out value="${u.firstName}" escapeXml="true" default=""/><c:out value="${u.lastname}" default="" escapeXml="true"/> <br />
														<b>Mobile Number :</b> <a href='<spring:url value="/Admin/User/${u.contactNo}" />'><c:out value="${u.contactNo}" escapeXml="true" default=""/></a><br />
														<b>Email ID :</b><c:out value="${u.email}" escapeXml="true" default=""/></td>
													<td>Balance :<c:out value="${u.balance}" escapeXml="true" default=""/><br />
