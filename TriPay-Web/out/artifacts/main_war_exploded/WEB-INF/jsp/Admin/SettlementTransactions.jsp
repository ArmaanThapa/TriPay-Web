                                    ...
                                    <c:forEach items="${transactions}" var="transaction"
                                        ...
                                        <tr>
                                            ...
                                            <td><c:out value="${transaction.transactionRefNo}"
                                                       default="" escapeXml="true" /></td>
                                            <td><c:out value="${transaction.description}"
                                                       escapeXml="true" default="" /></td>
                                            <td><c:out value="${transaction.amount}"
                                                       escapeXml="true" default="" /></td>
                                            <td><c:out value="${transaction.debit}"
                                                       escapeXml="true" default="" /></td>
                                            <td><c:out value="${transaction.service}" default=""
                                                       escapeXml="true" /></td>
                                            <td><c:out value="${transaction.status}" default=""
                                                       escapeXml="true" /></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
