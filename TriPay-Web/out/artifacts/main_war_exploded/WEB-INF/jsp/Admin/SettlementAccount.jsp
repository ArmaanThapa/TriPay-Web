...
<sec:csrfMetaTags/>
<title>VPayQwik | Settlement Report</title>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Settlement Account Transactions</h3>
						</div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
					  <form action="<c:url value="/Admin/SettlementAccount"/>" method="post" class="form form-inline">
						  ...
						  To <input type="text" id="toDate" name="endDate" class="form-control" readonly/>
					  		Service Type <select name="serviceType" class="from-control">
								<option value="TOPUPBILL">Topup And Bill Payment</option>
					 			 <option value="LOADMONEY">Load Money</option>
				  </select>
						  <sec:csrfInput/>
