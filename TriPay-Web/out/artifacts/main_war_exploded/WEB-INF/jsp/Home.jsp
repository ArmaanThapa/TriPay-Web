	...
	<div id="myCarousel" class="carousel slide" style="margin-top: -14px; position: fixed; z-index: -1; height: 100%; width: 100%;">
		...
		<div class="carousel-inner">
			<div class="item active">
				...
				<div class="fill" style="background-image:url('/resources/images/bg_vpayqwik.jpg');"></div>
			</div>
		</div>
			...
			<div class="container" style="margin-top: 8px;">
				<ul class="nav navbar-nav navbar-right">
					<form id="login"
						...
						<div class="group">
							<input type="password" name="password" id="password_login" autocomplete="off"
								  minlength="6" maxlength="9" required><span class="highlight"></span>
							<span class="bar"></span> <label>Password</label><i class="fa fa-eye-slash" id="login_pwd_eye" style="float: right;margin-top: -25px;"></i>
							<sec:csrfInput/>
							<a href="#" data-toggle="modal" data-target="#forgotPassword" id="forgot_password_modal">Forgot
								Password? </a>
						</div>
	...
	<div class="container">
		...
		<div class="col-xs-12 col-sm-6 col-md-4"
			...
			<form action="#" method="post">
				...
				<div class="group">
					<input id="dob" type="text"  required="required" readonly/>
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content text-center" style="width: 120%;">
				...
				<form style="    margin-left: 30px;">
					<div class="group_1">
						<input type="text" name="username" id="fp_username" placeholder="Mobile Number"
					...
					<img src="/Captcha" height="80" class="captcha_image"/> <br/>	<div class="group_1">
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content text-center">
				...
				<div class="group_1" style="margin-left: 20px;">
					<input type="text" name=key id="fpOTP_key" placeholder="OTP" required/>
				</div>
				<div class="group_1" style="margin-left: 20px;">
					<input type="password" name=key id="fpnewPassword_key" minlength="6" maxlength="6" placeholder="New Password" required/>
				</div>
				<div class="group_1" style="margin-left: 20px;">
					<input type="password" name=key id="fpconfirmPassword_key" minlength="6" maxlength="6" placeholder="Confirm Password" required/>
				</div><br/>
				<div class="group_1">
