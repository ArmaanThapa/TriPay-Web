...
<sec:csrfMetaTags/>
<title>VPayQwik | Male Users</title>
										...
										<tbody>
											<c:forEach items="${userList}" var="u" varStatus="loopCount">
												<tr>
													...
													<td><b>User Name : </b><c:out value="${u.username}" default="" escapeXml="true"/> <c:out value="${u.lastname}" escapeXml="true" default=""/><br />
														<b>Mobile Number :</b> <a href='<spring:url value="/Admin/User/${u.contactNo}" />'><c:out value="${u.contactNo}" escapeXml="true" default=""/></a><br />
														<b>Email ID :</b><c:out value="${u.email}" default="" escapeXml="true"/></td>
													 
													<td>Balance :<c:out value="${u.balance}" default="" escapeXml=""/><br />
