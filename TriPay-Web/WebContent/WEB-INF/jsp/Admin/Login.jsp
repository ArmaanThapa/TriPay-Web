...
<link href="<c:url value="/resources/css/css_style.css"/>" rel='stylesheet' type='text/css'>
			...
			<div class="container">
				<div class="navbar-header">
					<a class="navbar-brand" href="#"><img
						src="${pageContext.request.contextPath}/resources/images/tripaylogo.png"
						alt="" style="width: 230px"></a>
				</div>
		...
		<div class="container-fluid">			
			<div class="span pull-left">
				<%-- <a href="#"><img
							...
							style="height: 30px; margin-top: 10px;"></a --%>
			</div>
