...
<sec:csrfMetaTags />
<title>VPayQwik | Commission Filtered Report</title>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>commission Filtered Results</h3>
						</div>
										...
										<tbody id="userList">
											<c:forEach items="${userList}" var="userList"
												...
												<tr>
													...
													<td><c:out value="${userList.dateOfTransaction}" default=""
															escapeXml="true" /> 
															</td>
													...
													<td><c:out value="${userList.commission}"
															escapeXml="true" default="" /></td>
