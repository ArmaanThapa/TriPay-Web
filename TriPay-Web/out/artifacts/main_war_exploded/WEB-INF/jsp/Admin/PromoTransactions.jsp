										...
										<tbody id="userList">
											<c:forEach items="${userList}" var="user"
												...
												<tr>
													...
													<td><b>Contact No :</b> <a href='<spring:url value="/Admin/User/${user.contactNo}" />'><c:out value="${user.contactNo}" escapeXml="true" default=""/></a> <br/>
														<b>Email :</b> <c:out value="${user.email}" escapeXml="true"/> <br/>
													</td>
													<td><c:out value="${user.transactionRefNo}"
															default="" escapeXml="true" /></td>
													<td><c:out value="${user.dateOfTransaction}"
															default="" escapeXml="true" /></td>
													<td><c:out value="${user.firstName}"
															escapeXml="true" default="" /></td>
													<td><c:out value="${user.amount}"
															   escapeXml="true" default="" /></td>
													<td><c:out value="${user.status}" default=""
															escapeXml="true" /></td>
												</tr>
											</c:forEach>
										</tbody>
