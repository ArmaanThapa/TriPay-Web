...
<body onload="a2()" style="background-color:lightgray; margin-left:300px; margin-right:300px; margin-top:0px;">
    <center>
      ...
      <td align="left"><input type="text" id="return_url" name="return_url"/></td>
      <tr>
                <tr>
                    <td>Mode<span class="red">*</span></td>
                   <td align="left"><input id="mode" name="mode" type="text" value="LIVE" readonly="true"/></td>
                </tr>
    ...
    <td align="left"> <select id="algo" name="algo">
      ...
      <td align="left"><input type="text" id="reference_no" name="reference_no"/></td>
                     </tr>
      <tr>
 <td>Amount<span class="red">*</span></td>
      <td align="left"><input type="text" id="amount" name="amount"/></td>
      </tr>
         
                <tr>
                     <td>Description<span class="red">*</span></td>
                    <td align="left" width="50%"><input id="description" name="description" type="text" value="" /></td>
                </tr>
                <tr>
                 ...
                 <tr>
                    ...
                    <td align="left"><input id="name" name="name" type="text" value="" /></td>
                </tr>
                <tr>
                    <td>Address<span class="red">*</span></td>
                    <td align="left"><input id="address" name="address" type="text" value="" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left"><input id="state" name="state" type="text" value=""/></td>
                </tr>
                <tr>
                    <td>ZIP/Postal Code<span class="red">*</span></td>
                    <td align="left"><input id="postal_code" name="postal_code" type="text" value="" /></td>
                </tr>
                <tr>
             ...
             <tr>
                    ...
                    <td align="left"><input id="ship_name" name="ship_name" type="text" value="" /></td>
                </tr>
                <tr>
                    <td>Ship Address<span class="red">*</span></td>
                    <td align="left"><input id="ship_address" name="ship_address" type="text" value=""  /></td>
                </tr>
                <tr>
                    <td>Ship City<span class="red">*</span></td>
                    <td align="left"><input id="ship_city" name="ship_city" type="text" value=""  /></td>
                </tr>
                <tr>
                    <td>Ship State<span class="red">*</span></td>
                    <td align="left"><input id="ship_state" name="ship_state" type="text" value="" /></td>
                </tr>
                 <tr>
                  ...
                  <tr>
                    ...
                    <td align="left"><input id="ship_phone" name="ship_phone" type="text" value="" /></td>
                </tr>
                  <tr>
                    <td>Ship Postal Code<span class="red">*</span></td>
                    <td align="left"><input id="ship_postal_code" name="ship_postal_code" type="text" value="" /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="left" width="50%"><input id="name_on_card" name="name_on_card" type="text" value="" /></td>
                </tr>

                     <tr>
                    <td class="fieldName" width="50%">*Card Number</td>
                    <td align="left" width="50%"><input id="card_number" name="card_number" type="text" value=""  /></td>
                </tr>
                
              <tr>
                    <td class="fieldName" width="50%">*Card Expiry</td>
                    <td align="left" width="50%"><input id="card_expiry" name="card_expiry" type="text" value="" /></td>
                </tr>
                       <tr>
                    <td class="fieldName" width="50%">*CVV</td>
                    <td align="left" width="50%"><input id="card_cvv" name="card_cvv" type="password" value="" /></td>
                </tr></table>
