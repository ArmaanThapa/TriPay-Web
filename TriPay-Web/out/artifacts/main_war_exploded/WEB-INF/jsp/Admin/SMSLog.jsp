						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									...
									<div class="clearfix"></div>
									<form method="post"
										action="${pageContext.request.contextPath}/Admin/SMSLog">
										...
										<tbody id=userList>
											<c:forEach items="${userList}" var="userList">
												<tr>
													...
													<td><c:out value="${userList.commision}" escapeXml="true" default=""/></td>
													<td><c:out value="${userList.emailTemplate}" escapeXml="true" default=""/></td>
													<td><c:out value="${userList.contactNo}" escapeXml="true" default=""/></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
