...
<sec:csrfMetaTags />
<title>VPayQwik | Pool Account Report</title>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Pool Account Transactions</h3>
						</div>
					</div>
							...
							<div class="x_panel">
								<div class="x_title">
									...
									<ul class="nav navbar-right panel_toolbox">
										<%-- <form method="post"
											action="${pageContext.request.contextPath}/Admin/PoolTransactionByDate">
								...
								<div class="x_content">
									...
									<form action="<c:url value="/Admin/PoolAccount"/>" method="post" class="form form-inline">
											...
											<c:forEach items="${userList}" var="userList"
												...
												<tr>
													...
													<td><c:out value="${userList.username}" default=""
															escapeXml="true" /> | <c:out value="${userList.contactNo}" default=""
															escapeXml="true" /></td>
													<td><c:out value="${userList.transactionRefNo}"
															default="" escapeXml="true" /></td>
													<td><c:out value="${userList.dateOfTransaction}"
															default="" escapeXml="true" /></td>
													<td><c:out value="${userList.serviceType}"
															escapeXml="true" default="" /></td>
													<td><c:out value="${userList.credit}" escapeXml="true"
															default="" /></td>
													<td><c:out value="${userList.debit}" escapeXml="true"
															default="" /></td>
