...
<head>
	...
	<sec:csrfMetaTags/>
	<title>VPayQwik | Merchants List</title>
						...
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<table id="datatable"
									...
									<tbody>
									<c:forEach items="${userlist}" var="u" varStatus="loopCounter">
										<tr>
											<td>${loopCounter.count}</td>
											<td><c:out value="${u.firstName}" escapeXml="true" default=""/> </td>
											<td><a href="${pageContext.request.contextPath}/Admin/${u.email}/Merchant"><c:out value="${u.email}" escapeXml="true" default=""/></a><br/></td>
<%-- 											<td><c:out value="${u.email}" escapeXml="true" default=""/><br/></td> --%>
											<td>
												<c:out value="${u.contactNo}" escapeXml="true" default=""/>
											</td>
											<td><c:out value="${u.dateOfAccountCreation}" escapeXml="true" default=""/></td>
