...
<title>VPayQwik | Merchant Invoice</title>
<!-- Bootstrap core CSS -->
									...
									<section class="content invoice">
										...
										<div class="row invoice-info">
											<div class="col-sm-4 invoice-col">
												From
												<address>
													<strong>VPayQwik SOLUTION</strong> <br>106, 4th Cross <br>Koramangala,
										...
										<div class="row">
											...
											<div class="col-xs-6">
												<p class="lead">
													Payment Methods: <i>VPayQwik Payment Gateway</i>
												</p>
												<img
													src="${pageContext.request.contextPath}/resources/admin/images/logo_ios.png"
													alt="Visa">
												<p class="text-muted well well-sm no-shadow"
													style="margin-top: 10px;">VPayQwik is a Mobile wallet
