...
<footer>
	...
	<div class="container">
		...
		<div class="row">
			...
			<p>VPayQwik brings to you the various coupons, deals and offers to
			...
			<p>VPayQwik also provides travel ticket service, through VPayQwik
				...
				services at VPayQwik.VPayQwik make sure that every transaction you do
				is risk free.</p>
		</div>
		<hr>
		<div class="row" id="footericons">
			<div class="col-sm-8">
				<img src='<c:url value="/resources/images/main/footer_1.png"/>' style="width: 80px"
