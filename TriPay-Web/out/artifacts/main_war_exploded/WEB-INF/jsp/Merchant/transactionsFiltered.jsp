            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Merchant Filtered Results</h3>
                    </div>
...
<!--                                                          The Buttons extension for DataTables provides a common set of options, API methods and styling to display buttons on a page that will interact with a DataTable. The core library provides the based framework upon which plug-ins can built. -->
							<form action="<c:url value="/Merchant/TransactionFiltered"/>" method="post" class="form form-inline">
                                ...
                                <table id="datatable-buttons"
                                    ...
                                    <tbody id="userList">
                                    <c:forEach items="${txList}" var="neft"
                                               varStatus="loopCounter">
                                        <tr>
                                            <td>${loopCounter.count}</td>
                                            <td><b>Name:</b><c:out value="${neft.date}" default=""
                                                       escapeXml="true" />
                                              <td>  <b>Email:</b><c:out value="${neft.email}" default=""
                                                                   escapeXml="true" /><br>
                                                                   <b>ContactNo:</b>
                                                                   <c:out value="${neft.contactNo}" default=""
                                                                   escapeXml="true" />
                                            </td>
