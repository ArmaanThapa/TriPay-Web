										...
										<tbody id=userList>
											<c:forEach items="${userList}" var="userList">
												<tr>
													...
													<td><c:out value="${userList.emailTemplate}" default="" escapeXml="true"/></td>
													<td><c:out value="${userList.emailDestination}" default="" escapeXml="true"/></td>
													<td>TriPaycare@vijayabank.co.in</td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
