...
function calculateSendMoneyCommission(amount){
	var numericAmount = parseFloat(amount);
	if(numericAmount > 1 && numericAmount <= 999){
		return 0;
	}else if(numericAmount >=1000  && numericAmount <=4999){
			return 0;
	}else if(numericAmount >= 5000 && numericAmount <= 9999){
			return 0;
	}else if(numericAmount >= 10000 && numericAmount <= 50000){
		return 0;
	}
}
