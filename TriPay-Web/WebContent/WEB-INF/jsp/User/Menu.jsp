	...
	<nav id="menu" role="navigation">
		<center><ul>
			...
			<%--<a href="<c:url value="/User/Travel/BusTravel"/>"><i class="fa fa-suitcase fa-2x menufa" aria-hidden="true"style="font-size:25px;color:white"></i>Travel</a>--%>
				<%-- <a href="http://travel.TriPay.com/" target="_blank"> <i class="fa fa-suitcase fa-2x menufa"></i>
					<spring:message	code="page.user.menu.travel" /></a></li> --%>
				<%-- 	<a href="#" target="_blank"> <i class="fa fa-suitcase fa-2x menufa"></i>
					<spring:message	code="page.user.menu.travel" /></a></li> --%>
			...
			<%-- <li> <a href="<spring:url value="/User/SchoolPayment"/>"> <i class="fa fa-university fa-2x menufa"></i> <spring:message code="page.user.menu.schoolPayment" /></a></li> --%>
		</ul></center>
	</nav>
